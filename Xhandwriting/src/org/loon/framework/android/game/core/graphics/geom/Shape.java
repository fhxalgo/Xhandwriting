 ...
 * 
 * @see org.loon.framework.android.game.core.graphics.geom.PathIterator
 * @see org.loon.framework.android.game.core.graphics.geom.AffineTransform
 * @see org.loon.framework.android.game.core.graphics.geom.FlatteningPathIterator
 * @see org.loon.framework.android.game.core.graphics.geom.GeneralPath
 * 
 * @author Jim Graham
 * @since 1.2
 */
public interface Shape {
   ...
   * Shape}. The {@link org.loon.framework.android.game.core.graphics.geom.Area Area} class performs more accurate
   ...
   * @see org.loon.framework.android.game.core.graphics.geom.Area
   * @since 1.2
   */
   ...
   * {@link org.loon.framework.android.game.core.graphics.geom.Area Area} class performs more accurate geometric
   ...
   * The {@link org.loon.framework.android.game.core.graphics.geom.Area Area} class performs more accurate geometric
   * computations than most {@code Shape} objects and therefore can be used if
   * a more precise answer is required.
   * 
   * @param r
